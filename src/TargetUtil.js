...
class TargetUtil {
    ...
    static targetConditionMap = {
        ...
        onTouchStart: tmodel => getEvents().isStartEvent() && getEvents().isTouchHandlerOrChild(tmodel),
        onTouchEnd: tmodel => getEvents().isEndEvent() && getEvents().isTouchHandlerOrChild(tmodel),
        onKeyEvent: () => getEvents().getEventType() === 'key' && getEvents().currentKey,
        onSwipeEvent: tmodel => getEvents().isTouchHandlerOrChild(tmodel) && getEvents().isSwipeEvent(),        
